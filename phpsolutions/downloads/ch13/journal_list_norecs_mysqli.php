...
<table>
    ...
    <tr>
		...
		<td><a href="journal_update_mysqli.php?article_id=<?php echo $row['article_id']; ?>">EDIT</a></td>
		<td><a href="journal_delete_mysqli.php?article_id=<?php echo $row['article_id']; ?>">DELETE</a></td>
    </tr>
	<?php } ?>
</table>
<?php
